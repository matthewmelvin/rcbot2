--
-- premake5 script for RCBot2
-- Note: This script is for generating a visual studio solution for editing the source code, compiling should be done via AMBuild.
