...
public:
	...
	virtual void debugString(char* string, unsigned bufferSize) { string[0] = 0; }
...
{
public:
	CTF2_TauntTask(edict_t* pPlayer, const Vector& vOrigin, const float fDist)
		: m_pPlayer(pPlayer), m_vOrigin(vOrigin), m_fDist(fDist)
	{
		m_fTime = 0.0f;
		m_fTauntUntil = 0.0f;
		m_fActionTime = 0.0f;
